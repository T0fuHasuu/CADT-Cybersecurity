...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, closed));
    ...
    public Object m1680trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        if (offerInternal != null) {
            return ChannelResult.Companion.m1677closedJP2dKIU(offerInternal.getSendException());
        }
