...
public class ViewTransition {
    ...
    static class Animate {
        ...
        public void mutateReverse() {
            ...
            boolean interpolate = motionController.interpolate(motionController.mView, f3, nanoTime, this.mCache);
    ...
    public /* synthetic */ void m9lambda$applyTransition$0$androidxconstraintlayoutmotionwidgetViewTransition(View[] viewArr) {
        if (this.mSetsTag != -1) {
