...
public final class UMathKt {
    ...
    private static final int m1359minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1341minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1360mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1349minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1357maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1329maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1358maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1337maxOfeb3DHEI(j, j2);
    }
}
