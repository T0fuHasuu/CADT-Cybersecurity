...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1637copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1639copyRFiDyg4(t, j);
    }
    ...
    public final TimedValue<T> m1639copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1476equalsimpl0(this.duration, timedValue.duration);
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1499hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1520toStringimpl(this.duration) + ')';
    }
