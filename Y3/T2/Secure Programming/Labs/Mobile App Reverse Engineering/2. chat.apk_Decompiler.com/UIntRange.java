...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1375containsWZ4Q5Ns(((UInt) comparable).m286unboximpl());
    }

    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return UInt.m228boximpl(m1376getEndExclusivepVg5ArA());
    }

    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m228boximpl(m1377getEndInclusivepVg5ArA());
    }

    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m228boximpl(m1378getStartpVg5ArA());
    }
    ...
    public int m1376getEndExclusivepVg5ArA() {
        if (m1371getLastpVg5ArA() != -1) {
            return UInt.m234constructorimpl(m1371getLastpVg5ArA() + 1);
        }
        throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m1375containsWZ4Q5Ns(int i) {
        return Integer.compare(m1370getFirstpVg5ArA() ^ Integer.MIN_VALUE, i ^ Integer.MIN_VALUE) <= 0 && Integer.compare(i ^ Integer.MIN_VALUE, m1371getLastpVg5ArA() ^ Integer.MIN_VALUE) <= 0;
    }

    public boolean isEmpty() {
        return Integer.compare(m1370getFirstpVg5ArA() ^ Integer.MIN_VALUE, m1371getLastpVg5ArA() ^ Integer.MIN_VALUE) > 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UIntRange) {
            if (!isEmpty() || !((UIntRange) obj).isEmpty()) {
                ...
                if (!(m1370getFirstpVg5ArA() == uIntRange.m1370getFirstpVg5ArA() && m1371getLastpVg5ArA() == uIntRange.m1371getLastpVg5ArA())) {
                    return false;
                }
            }
            return true;
    ...
    public String toString() {
        return UInt.m280toStringimpl(m1370getFirstpVg5ArA()) + ".." + UInt.m280toStringimpl(m1371getLastpVg5ArA());
    }
