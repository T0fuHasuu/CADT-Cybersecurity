...
public class MonotonicCurveFit extends CurveFit {
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        int i = length - 1;
        double[][] dArr5 = (double[][]) Array.newInstance(Double.TYPE, new int[]{i, length2});
        double[][] dArr6 = (double[][]) Array.newInstance(Double.TYPE, new int[]{length, length2});
    ...
    private static MonotonicCurveFit buildWave(double[] dArr) {
        ...
        double[][] dArr3 = (double[][]) Array.newInstance(Double.TYPE, new int[]{length, 1});
