...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m1448minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m1466minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m1446elapsedNowUwyO8pc() {
            return Duration.m1506minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m1451plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1507plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m1449minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m1476equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1503isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m1573getZEROUwyO8pc();
                    }
                    long r2 = Duration.m1506minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m1476equalsimpl0(m1449minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m1573getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m1499hashCodeimpl(Duration.m1507plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m1520toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1573getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
