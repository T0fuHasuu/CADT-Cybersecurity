...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path path2, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function32) {
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
                ...
                if ((!z2 || !Files.isSameFile(path, path2)) && Intrinsics.areEqual((Object) path.getFileSystem(), (Object) path2.getFileSystem()) && (!z2 ? !((parent = path2.getParent()) == null || !Files.exists(parent, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) || !parent.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0]))) : path2.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0])))) {
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        ...
        L_0x0014:
            ...
            r6 = r5
            java.nio.file.DirectoryStream r6 = (java.nio.file.DirectoryStream) r6     // Catch:{ all -> 0x003a }
            boolean r7 = r6 instanceof java.nio.file.SecureDirectoryStream     // Catch:{ all -> 0x003a }
            if (r7 == 0) goto L_0x0031
            r0.setPath(r4)     // Catch:{ all -> 0x003a }
            java.nio.file.SecureDirectoryStream r6 = (java.nio.file.SecureDirectoryStream) r6     // Catch:{ all -> 0x003a }
            java.nio.file.Path r2 = r8.getFileName()     // Catch:{ all -> 0x003a }
            java.lang.String r4 = "this.fileName"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r4)     // Catch:{ all -> 0x003a }
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r6, r2, r0)     // Catch:{ all -> 0x003a }
            goto L_0x0032
        L_0x0031:
            r1 = r2
        L_0x0032:
