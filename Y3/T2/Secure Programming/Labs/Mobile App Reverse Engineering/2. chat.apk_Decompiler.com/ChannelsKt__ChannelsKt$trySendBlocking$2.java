    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m139constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m139constructorimpl(Unit.INSTANCE);
        if (Result.m146isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1679successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1677closedJP2dKIU(Result.m142exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1664boximpl(obj3);
    }
}
