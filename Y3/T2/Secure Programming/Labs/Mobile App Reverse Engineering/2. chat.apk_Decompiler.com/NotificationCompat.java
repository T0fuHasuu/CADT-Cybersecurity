...
public class NotificationCompat {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (action.getIcon() == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, z4);
        }
        if (action.getIcon() != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, z4);
    }
