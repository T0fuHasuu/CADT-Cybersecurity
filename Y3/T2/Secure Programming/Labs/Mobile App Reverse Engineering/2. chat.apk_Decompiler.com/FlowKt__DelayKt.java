...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1691debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1644toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1692sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1644toDelayMillisLRDsOJo(j));
    }
}
