...
public final class DelayKt {
    ...
    public static final Object m1643delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1644toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1644toDelayMillisLRDsOJo(long j) {
        if (Duration.m1470compareToLRDsOJo(j, Duration.Companion.m1573getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1489getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
