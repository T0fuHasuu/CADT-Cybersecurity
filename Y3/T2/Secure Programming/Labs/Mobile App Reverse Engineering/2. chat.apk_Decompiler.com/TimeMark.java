...
public interface TimeMark {
    ...
    TimeMark m1608minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1609plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1610minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.m1609plusLRDsOJo(Duration.m1523unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1504isNegativeimpl(timeMark.m1607elapsedNowUwyO8pc());
        }
