...
class MaterialCardViewHelper {
    ...
    public void animateCheckedIcon(boolean z) {
        ...
        this.iconAnimator.setDuration((long) (((float) (z ? this.iconFadeInAnimDuration : this.iconFadeOutAnimDuration)) * f2));
    ...
    public /* synthetic */ void m44lambda$animateCheckedIcon$0$comgoogleandroidmaterialcardMaterialCardViewHelper(ValueAnimator valueAnimator) {
    ...
    public void recalculateCheckedIconPosition(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            int i7 = isCheckedIconEnd() ? ((i - this.checkedIconMargin) - this.checkedIconSize) - i3 : this.checkedIconMargin;
            int i8 = isCheckedIconBottom() ? this.checkedIconMargin : ((i2 - this.checkedIconMargin) - this.checkedIconSize) - i4;
            int i9 = isCheckedIconEnd() ? this.checkedIconMargin : ((i - this.checkedIconMargin) - this.checkedIconSize) - i3;
            int i10 = isCheckedIconBottom() ? ((i2 - this.checkedIconMargin) - this.checkedIconSize) - i4 : this.checkedIconMargin;
