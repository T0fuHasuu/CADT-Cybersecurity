...
public final class Result<T> implements Serializable {
    ...
    public static boolean m140equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m148unboximpl());
    }
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m139constructorimpl(t);
        }

        private final <T> Object failure(Throwable th) {
            Intrinsics.checkNotNullParameter(th, "exception");
            return Result.m139constructorimpl(ResultKt.createFailure(th));
        }
    }
