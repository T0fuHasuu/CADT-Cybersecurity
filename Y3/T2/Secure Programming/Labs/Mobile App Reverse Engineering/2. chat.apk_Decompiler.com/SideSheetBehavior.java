...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public /* synthetic */ void m114lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i) {
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new SideSheetBehavior$$ExternalSyntheticLambda0(this, marginLayoutParams, this.sheetDelegate.getCoplanarSiblingAdjacentMargin(marginLayoutParams), coplanarSiblingView);
    }
    ...
    public /* synthetic */ void m113lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    class StateSettlingTracker {
        ...
        public /* synthetic */ void m115lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(int i) {
        return new SideSheetBehavior$$ExternalSyntheticLambda2(this, i);
    }
    ...
    public /* synthetic */ boolean m112lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i, View view, AccessibilityViewCommand.CommandArguments commandArguments) {
        setState(i);
        return true;
    }
}
