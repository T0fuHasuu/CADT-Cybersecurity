...
public class LoginRestApi {
    ...
    private Integer  loginAttemptQuantity;
    ...
    public Response authenticateByLogin(@FormParam("username") String username,
                                        ...
                                        @FormParam("loginAttemptQuantity") Integer
                                                    attemptQuantity
    ) {
        try {
            loginAttemptQuantity = attemptQuantity;
            login(
    ...
    private void login(String username, String password)
        ...
        if (credential != null
                && loginAttemptService.getLoginAttemptsCountByUsername(
                credential.getCaller()) > loginAttemptQuantity) {
